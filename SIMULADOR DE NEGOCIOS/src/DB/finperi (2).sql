...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-12-2018 a las 18:13:14
...
(1, 4, 'vgvggvg', 8, 9, 9, 'ghgvghvgh', 'bghggh', 'hgvhgvghv', 'vgvghvgh', 'vghvghv', 'vghvhg', 'vgv', 'vgvhg', 'hbhjbhb'),
(2, 4, 'bvghv', 8, 8, 8, 'bhbh', 'gvhgv', 'v', 'vghv', 'gvghv', 'vhgvgh', 'vgh', 'gvhgv', 'ghvhgv');
...
(1, 'papi', 'viva2', 2, 4, 5, 2, 2, 1),
(2, 'ffj', 'hh', 3333, 3, 4, 5, 2, 2);
...
(4, 'cfcfgc', 'fcgfcfg', '2018-11-01', 11);
...
--
ALTER TABLE `manoobraoperativa`
  MODIFY `idmanoObraOperativa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `tipogastooperativo`
  MODIFY `idtipoGasto` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
--
...
--
ALTER TABLE `tiposinversiones`
  MODIFY `idtiposInversiones` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
--
-- AUTO_INCREMENT de la tabla `tipousuario`
--
ALTER TABLE `tipousuario`
  MODIFY `idtipoUsuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
